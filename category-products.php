    ...
    <?php 
        ...
        if(isset($_GET['category_id']))
        {
            ...
            $sql = "SELECT title FROM wattco_category WHERE id=$category_id";
    ...
    <section class="product-search text-center">
        <div class="container">
            ...
            <h2><a href="#" class="text-black"><?php echo $category_title; ?></a></h2>
    ...
    <section class="product-menu">
        <div class="container">
            ...
            <?php 
                ...
                $sql2 = "SELECT * FROM wattco_product WHERE category_id=$category_id";
                            ...
                            <div class="product-menu-img">
                                <?php 
                                    ...
                                    else
                                    {
                                        //Image Available
                                        ?>
                                        <img src="<?php echo SITEURL; ?>images/products/<?php echo $image_name; ?>" alt="Wattcoo" class="img-responsive img-curve">
                                        <?php
                                    }
                                ?>
