    ...
    <section class="product-menu">
        <div class="container">
            ...
            <?php 
                ...
                // "SELECT * FROM wattco_product WHERE title LIKE '%burger'%' OR description LIKE '%burger%'";
                $sql = "SELECT * FROM wattco_product WHERE title LIKE '%$search%' OR description LIKE '%$search%'";
                        ...
                        <div class="product-menu-box">
                            <div class="product-menu-img">
                                <?php 
                                    ...
                                    {
                                        //Image not Available
                                        echo "<h5 class='text-red'>Image not Available</h3>";
                                    }
                                    else
                                    {
                                        //Image Available
                ...
                else
                {
                    ...
                    echo "<h3 class='text-red'>Product Not Found</h3>";
                }
