...
const deviceName = document.querySelector("#s-1"); //from device name field
...
deviceName.addEventListener('input', ()=>{
  switch (deviceName.value) {
    ...
    case 'Room Cooler':
      ...
      break;
    case 'AC':
      wattsInput.value = 1200;
      break;
    case 'Refrigerator':
      wattsInput.value = 350;
    break;
    case 'Washing Machine':
      wattsInput.value = 1000;
    break;
    case 'Light Bulb':
      wattsInput.value = 40;
    break;
    case 'Projector':
      wattsInput.value = 600;
    break;
    case 'Water Pump (0.5 HP)':
      wattsInput.value = 400;
    break;
...
const addListItems = (nameOfDevice, wattsOfDevice, hoursInUse, sumOfHours, sumOfWatts, power)=>{ 
    ...
    deleteBtn.innerHTML = `<button style = "cursor: pointer;" id="addBtn" class="btn btn-danger btn-4">DELETE</button>`;
